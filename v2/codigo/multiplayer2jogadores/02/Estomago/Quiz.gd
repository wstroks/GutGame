...
func set_question():
	...
	if childAmount >0:
		...
		if(score>=3):
			...
			multi_player.tabuleiro1(3)
			multi_player._playervai1("res://codigo/multiplayer2jogadores/03/jogador1/Quiz.tscn")
			get_tree().change_scene(str(multi_player._playerondevai2()))
			multi_player.vez("Jogador 2")
		else:
			multi_player._player1("Estômago",score)
			multi_player.tabuleiro1(2)
			multi_player._playervai1("res://codigo/multiplayer2jogadores/02/Estomago/Quiz.tscn")
			get_tree().change_scene(str(multi_player._playerondevai2()))
			multi_player.vez("Jogador 2")
