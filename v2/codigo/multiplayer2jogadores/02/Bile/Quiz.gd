...
func set_question():
	...
	if childAmount >0:
		...
		if(score>=3):
			...
			multi_player.tabuleiro2(3)
			multi_player._playervai2("res://codigo/multiplayer2jogadores/03/jogador2/Quiz.tscn")
			get_tree().change_scene("res://codigo/multiplayer2jogadores/feedback.tscn")
			multi_player.vez("Jogador 1")
		else:
			multi_player._player2("Bile",score)
			multi_player.tabuleiro2(2)
