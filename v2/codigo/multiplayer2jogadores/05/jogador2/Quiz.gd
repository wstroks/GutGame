...
func set_question():
	...
	if childAmount >0:
		...
		if(score>=3):
			multi_player._player2("Intestino Grosso",score)
			multi_player.tabuleiro2(6)
			multi_player._playervai2("res://codigo/multiplayer2jogadores/06/jogador2/Quiz.tscn")
			get_tree().change_scene("res://codigo/multiplayer2jogadores/feedback.tscn")
			multi_player.vez("Jogador 1")
		else:
			multi_player._player2("Intestino Delgado",score)
			multi_player.tabuleiro2(5)
			multi_player._playervai2(str(multi_player._playerondevai2()))
			get_tree().change_scene("res://codigo/multiplayer2jogadores/feedback.tscn")
			multi_player.vez("Jogador 1")
